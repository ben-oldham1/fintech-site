        ...
        <>
            <div class="flex flex-row m-12 mx-16 lg:mx-32">
                <div class="basis-3/5">
                    ...
                    <h2 className='mt-6 mb-2 text-2xl font-bold'>What is Blockchain?</h2>
                    <p className='mb-2'>
                    ...
                    <h2 className='mt-6 mb-2 text-2xl font-bold'>Decentralization and Trust</h2>
                    <p className='mb-2'>
                    ...
                    <h2 className='mt-6 mb-2 text-2xl font-bold'>Cryptocurrencies and Blockchain</h2>
                    <p className='mb-2'>
                    ...
                    <h2 className='mt-6 mb-2 text-2xl font-bold'>Transparency and Immutability</h2>
                    <p className='mb-2'>
                    ...
                    <h2 className='mt-6 mb-2 text-2xl font-bold'>Smart Contracts</h2>
                    <p className='mb-2'>
                    ...
                    <h2 className='mt-6 mb-2 text-2xl font-bold'>Conclusion</h2>
                    <p className='mb-2'>
